  ...
  return (
    ...
    >
      <div className="flex justify-center items-center">
        <ul className="space-y-4">
          <li className="flex items-center">
            ...
            <p className="text-xl">+62 812-3612-2611-0988</p>
          </li>
          <li className="flex items-center">
            <Image src={mail} alt="mail" className="h-[110px] w-auto mr-6" />
            <p className="text-xl">naufalfathi37@gmail.com</p>
          </li>
        </ul>
      </div>
      ...
      <div className="bg-white/10 p-6 rounded-xl max-w-[550px]">
        ...
        <form
          className="space-y-4"
          action="https://getform.io/f/byvpggna"  
          method="POST"
        >
          ...
          <textarea
            ...
            required
          />
          <button className="bg-orange-500 text-white px-6 py-2 w-full font-semibold text-xl rounded-xl">
            Send Message
          </button>
        </form>
      </div>
